...
/* Вспомогательная функция конвертации числа флоат без дробной части в структуру децимал с минимальными потерями точности.*/
void float_n(unsigned int src_b, s21_decimal *dst);
/* Вспомогательная функция конвертации числа флоат с дробной частью в структуру децимал.*/
